<template>
  <q-page padding>
    <top-bar
      ...
      @passGroupByv="getSelectedGroupBy"
      pageTitle="Vendors"
    />
    ...
    <charts-taple
      ...
      :moreBtn="moreBtn"
      :isPendeng="isPendeng"
      deleteAction="AppModule/AdministrationModule/ChartsModule/chartsVendor/deleteVendor"
      :createBtn="true"
      @createDilaog="createDilaog"
      @remount="handelGetChart"
    />
    ...
    >
      <vendors-filter @passFilterData="confermFilter" />
    </q-dialog>
  </q-page>
</template>
...
const { useActions } = createNamespacedHelpers(
  "AppModule/AdministrationModule/ChartsModule/chartsVendor"
);
import TopBar from "../../../components/top-bar.vue";
import VendorsFilter from "../components/vendors-filter.vue";
export default {
  components: { TopBar, VendorsFilter, ChartsTaple },
  setup() {
    ...
    // api
    const { getMainVendorList, deleteVendor } = useActions([
      "getMainVendorList",
      "deleteVendor",
    ]);
    // methods
    ...
    const getSelectedGroupBy = (sselected) => {
      // do filter
    };
    const handelGetChart = () => {
      getMainVendorList().then((res) => {
