        ...
        >
          ...
          >
            <q-list style="min-width: 200px">
              ...
              <q-item clickable @click="exportshreet('face-direction')">
    ...
    <div class="q-my-md prperty-taple">
          ...
          <q-card-section class="row justify-between items-center">
            ...
            <div class="col-12">
              <q-input
                ...
                :error="isNameExist"
                :error-message="$t('this name is used')"
              />
              <q-input
                v-else
                outlined
                ...
                class="user-search"
                placeholder="Face direction name"
                @update:model-value="checkNameExist"
                :error="isNameExist"
                :error-message="$t('name is used')"
              />
            </div>
          </q-card-section>
      ...
      >
        <ImportSteper
          ...
          titleImport="Import face direction"
...
export default {
  setup() {
    ...
    // api
    const {
      getAllFaceDirections,
      getFaceDirectionById,
      dublicateFaceDirections,
      updateFaceDirections,
      deleteFaceDirection,
      searchFaceDirection,
      createFaceDirection,
      chackNameFaceDirection,
    } = useActions([
      "getAllFaceDirections",
      "getFaceDirectionById",
      "dublicateFaceDirections",
