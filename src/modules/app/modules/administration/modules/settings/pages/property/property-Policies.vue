<template>
  <q-page padding>
    <div class="title-page q-pa-md text-h5">
      {{ $t("app.administration.settings.policies.title") }}
    </div>
    <!-- /////////// -->
    <!-- upper taple -->
    <!-- /////////// -->
        ...
        >
          ...
          >
            <q-list style="min-width: 200px">
              ...
              <q-item clickable @click="exportshreet('Policies')">
      ...
      >
        <q-card style="width: 50% !important">
          ...
          <q-card-section class="row justify-between items-center">
            <div v class="col-4 text-body1">
              {{ $t("app.administration.settings.policies.Property_Name") }}
            </div>
            <div class="col-7">
              <q-input
                v-if="!isDialogEite"
                ...
                :error="isNameExist"
                :error-message="
                  $t('app.administration.settings.policies.err_msg.dublicate')
                "
              />
              <q-input
                v-else
          ...
          <q-card-section class="row justify-between items-center">
            <div v class="col-4 text-body1">
              {{ $t("app.administration.settings.policies.terms_name") }}
            </div>
            <div class="col-7">
              <!-- <q-editor
                v-if="!isDialogEite"
                v-model="add_model_obj['terms']"
                max-height="6em"
                min-height="6em"
              /> -->
              <q-input
          ...
          <q-card-section class="row justify-between items-center">
            <div class="col-4 text-body1">
              {{ $t("app.administration.settings.policies.policy_doc") }}
            </div>
            <div class="col-7 flex items-center">
              <q-file
                v-if="!isDialogEite"
                v-model="add_model_obj['file']"
                :label="$t('app.administration.settings.policies.select_file')"
                outlined
                counter
                max-files="1"
...
export default {
  setup() {
    const { t } = useI18n();
    const col = ref([
      `${t("app.administration.settings.policies.col.name")}`,
