<template>
  <q-page padding>
    <div class="title-page q-pa-md text-h5">
      {{ $t("app.administration.settings.blocks.title") }}
    </div>
    <!-- /////////// -->
    <!-- upper taple -->
    <!-- /////////// -->
          ...
          <q-card-section class="row justify-between items-center">
            ...
            <div class="col-12">
              <q-input
                ...
                :error="isNameExist"
                :error-message="
                  $t('app.administration.settings.blocks.err_msg.dublicate')
                "
              />
              <q-input
                v-else
...
export default {
  setup() {
    ...
    const col = ref([`${t("app.administration.settings.blocks.col")}`]);
    const privpage = () => {
