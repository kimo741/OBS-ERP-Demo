<template>
  <q-page padding>
    <div class="title-page q-pa-md text-h5">
      {{ $t("app.administration.settings.unit_category.title") }}
    </div>
    <!-- /////////// -->
    <!-- upper taple -->
    <!-- /////////// -->
        ...
        >
          ...
          >
            <q-list style="min-width: 200px">
              ...
              <q-item clickable @click="exportshreet('unit-category')">
    ...
    <div class="q-my-md prperty-taple">
        ...
        <q-card class="full-width">
          ...
          <q-card-section class="row justify-between items-center">
            <!-- <div class="col-4 text-body1">
              {{
                $t("app.administration.settings.unit_category.Property_Name")
              }}
            </div> -->
            <div class="col-12">
              <q-input
                ...
                :error-message="
                  $t(
                    'app.administration.settings.unit_category.err_msg.dublicate'
                  )
                "
              />
              <q-input
      ...
      >
        <ImportSteper
          ...
          titleImport="Import Unit Category"
...
export default {
  setup() {
    const { t } = useI18n();
    const col = ref([`${t("app.administration.settings.unit_category.col")}`]);
    // methods
    watch(pageSize, (val) => {
      getMainData();
    });
    ...
    const {
      ...
      editUnitCategory,
      exporUnitCategory,
      duplicateUnitCategory,
      importUnitCategory,
      searchUnitCategory,
      checkUnitCategoryNameExist,
      handleDeleteSectorImport,
      checkUnitCategoryImportError,
    } = useActions([
      "getAllUnitCategory",
      "addUnitCategory",
      "deleteUnitCategory",
