<template>
  <q-page padding>
    <div class="title-page q-pa-md text-h5">
      {{ $t("app.administration.settings.unit_type.title") }}
    </div>
    <!-- /////////// -->
    <!-- upper taple -->
    <!-- /////////// -->
        ...
        >
          ...
          >
            <q-list style="min-width: 200px">
              ...
              <q-item clickable @click="exportshreet('unit-types')">
          ...
          <q-card-section class="row justify-between items-center">
            ...
            <div class="col-12">
              <q-input
                ...
                :error="isNameExist"
                :error-message="
                  $t('app.administration.settings.unit_type.err_msg.dublicate')
                "
              />
              <q-input
                v-else
...
export default {
  setup() {
    const { t } = useI18n();
    const col = ref([`${t("app.administration.settings.unit_type.col")}`]);
    watch(pageSize, (val) => {
      getMainData();
    });
    ...
    const {
      ...
      duplicateUnitType,
      searchUnitTypes,
      checkUnitTypeNameExist,
      checkUnitTypeImportError,
    } = useActions([
      "getAllUnitTypes",
      "createUnitType",
      "deleteUnitType",
