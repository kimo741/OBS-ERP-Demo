  ...
  <q-page padding>
    <div class="bg-white shadow-1 q-pa-lg q-mb-md">
      ...
      <div class="row items-start">
        <obs-text-field
          :label="$t('app.administration.users.appAccessGroups.search')"
          class="col q-mr-md"
        />
      </div>
      <!-- Actions -->
      <div class="row  reverse-wrap justify-between items-center">
        <div class="q-gutter-sm col-md-6">
          <obs-form-action
            to="app-group-details"
            :label="$t('app.administration.users.appAccessGroups.create')"
          />
          <obs-form-action
            to="app-group-details"
            outline
            :label="$t('app.administration.users.appAccessGroups.edit')"
          />
          <obs-form-action
            outline
            :label="$t('app.administration.users.appAccessGroups.duplicate')"
          />

          <obs-form-action
            outline
            :label="$t('app.administration.users.appAccessGroups.delete')"
          />
        </div>
      ...
      <obs-table
         :hide-header="$q.screen.lt.lg"
          ...
          :columns="[
            ...
            {
              name: 'groupName',
              label: $t('app.administration.users.appAccessGroups.groupName'),
              field: 'groupName',
              align: 'left',
            },
            {
              name: 'docAccess',
              label: $t('app.administration.users.appAccessGroups.docAccess'),
              field: 'login',
              align: 'left',
            },
            {
              name: 'company',
              label: $t('app.administration.users.appAccessGroups.company'),
              field: 'company',
              align: 'left',
            }
