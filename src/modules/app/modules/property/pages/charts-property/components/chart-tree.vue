<template>
  ...
  >
    ...
    <div v-if="!isByGroupTaple" class="main-taple full-width">
      <!-- head -->
      <div
        class="row main-taple__head col-12 row justify-around items-center text-left"
      >
        ...
        <div class="col-2">
          {{ $t("app.administration.charts.chartsProperty.property_name") }}
        </div>
        <div class="col-1">
        ...
        <div class="col-2">
          {{ $t("app.administration.charts.chartsProperty.address") }}
        </div>
        <div class="col-1">
          {{ $t("Activation") }}
        </div>
        ...
        <div class="col-12" v-if="mainData.length">
          ...
          >
            ...
            <div class="col-12 row justify-around items-center">
              <div style="flex-wrap: nowrap" class="col-1 row justify-start">
                <q-checkbox
                  class="col-6"
              ...
              <div class="text-left" style="width: 10px">{{ i + 1 }}</div>
              <div
                :class="see_more.includes(item) ? 'handel-wrab' : ''"
                @click="seeMore(item)"
                class="col-2 block-wrab text-left"
              >
                {{ gorop.name }}
              </div>
              <div class="col-1 text-left">
                {{ gorop.typeName ? gorop.typeName : "N/A" }}
              </div>
              <div class="col-2 text-center row justify-center">
                <div class="col-12">
                  <div class="row justify-around">
                    <div class="col-3">({{ gorop.vacant }})</div>
                    <div class="col-3">({{ gorop.underMaintenance }})</div>
                    <div class="col-3">({{ gorop.occupied }})</div>
                  </div>
                </div>
                <div class="col-12">
                  <div class="row justify-around">
                    <div class="col-3"><q-badge rounded color="green" /></div>
                    <div class="col-3"><q-badge rounded color="warning" /></div>
                    <div class="col-3"><q-badge rounded color="red" /></div>
                  </div>
                </div>
              </div>
              <div class="col-2 text-left">
                ...
                <div
                  :class="see_more.includes(item) ? 'handel-wrab' : ''"
                  @click="seeMore(item)"
                  class="block-wrab text-left"
                  style="display: block"
                >
                  {{ gorop.address ? gorop.address : "N/A" }}
                </div>
              </div>
              <div class="col-1 text-left">
                <div class="row justify-around items-center text-body1">
                  <div class="col-10">
                    ...
                    <q-badge v-if="gorop.isActive" color="green">{{
              ...
              >
                ...
                >
                  <transition-group name="slide-fade" class="full-width">
                    <div
                      class="col-12 full-width row justify-around items-center main-taple__body-item"
                      v-if="ItemsOfGroup.includes(gorop.id)"
                    >
                      <div class="col-1 block-wrab">
                        <q-checkbox
                      ...
                      <div class="col-1 block-wrab">{{ j + 1 }}</div>
                      <div
                      ...
                      <div class="col-2">
                        <div class="col-2 row justify-center">
                          <div class="col-12">
                            <div class="row justify-center col-5">
                              <div class="col-12">
                                <q-badge
                                  v-if="item.status == 1"
                                  rounded
                              ...
                              <div v-if="item.status == 3" class="col-12">
                        ...
                        <!-- <div class="row justify-around items-center text-body1">
                          <div class="col-11">
                            <q-badge
                              ...
                              >Active</q-badge
                            >
                            <q-badge class="full-width" v-else color="red"
                              >Not Active</q-badge
                            >
                          </div>
                        </div> -->
                      ...
                      <div class="col-1 row justify-center">
                        ...
                        >
                          ...
                          >
                            <q-list style="min-width: 200px">
                              <q-item
                                @click="$emit('duplicateSingleProp', item)"
                                clickable
                              >
                                <q-item-section>{{
                                  $t("global.duplicate")
                              ...
                              <q-item
                                @click="$emit('singleGroupToEdit', item)"
                                clickable
                              >
                                <q-item-section>{{
                                  $t("global.edit")
                              ...
                              <q-item
                                @click="$emit('singleGroupToDel', item)"
                                clickable
                              >
                                <q-item-section>{{
                                  $t("global.delete")
                              ...
                              <q-item
                                @click="$emit('copySingleProperty', item)"
                                clickable
                              >
                                <q-item-section>{{
                                  $t("global.copy")
                              ...
                              <q-item
                                @click="$emit('cutSingleProperty', item)"
                                clickable
                              >
                                <q-item-section>{{
                                  $t("global.cut")
  ...
  <div
    v-show="layout === 'list'"
    class="paaenation row justify-end items-center q-mt-md"
  >
    ...
    <div class="q-mx-md">
      <q-pagination
        v-model="pagenation.currentPage"
  ...
  <div v-show="layout !== 'list'">
    <div
      ...
      class="full-width row items-between main-taple"
    >
      <chart-as-card
    ...
    <div class="paaenation row justify-end items-end q-mt-md full-height">
      <div class="row items-center">
        <div class="q-mx-md">Records per page:</div>
        <div>
          <q-select
