        ...
        <div class="pdf-body">
          ...
          <div class="feild-width">
            ...
            <span class="feild-width__result">
              {{ create_item_model.translations[0].name }}
            </span>
          </div>
          <div class="feild-width">
            <span class="feild-width__title"> Activation </span> :
            <span class="feild-width__result">
              {{ create_item_model.isActive ? Yes : No }}
            </span>
          </div>
          <div class="feild-width">
          ...
          <div class="feild-width">
            <span class="feild-width__title"> City name </span> :
            <span class="feild-width__result">{{
              create_item_model.address.cityName
            }}</span>
          </div>
          <div class="feild-width">
            <span class="feild-width__title"> Country </span> :
            <span class="feild-width__result">{{
              getLabelById(create_item_model.address.countryId, cuntries_List)
            }}</span>
          </div>
          <div class="feild-width">
          ...
          <div class="feild-width">
            <span class="feild-width__title">zip Code</span> :
            <span class="feild-width__result">{{
              create_item_model.address.zipCode
            }}</span>
          </div>
          <!-- <q-separator class="full-width q-my-md" /> -->
          ...
          <div class="feild-width">
            ...
            <span class="feild-width__result">{{
              create_item_model.contact.name
            }}</span>
          </div>
          <div class="feild-width">
            <span class="feild-width__title">Menager name</span> :
            <span class="feild-width__result">{{
              create_item_model.contact.jopPostition
            }}</span>
          </div>
          <div class="feild-width">
            <span class="feild-width__title">Phone Num</span> :
            <span class="feild-width__result">{{
              create_item_model.contact.phoneObj.phoneNumber
            }}</span>
          </div>
          <!-- <q-separator class="full-width q-my-md" /> -->
          <div class="section-title">Owners</div>
          <div
            v-for="(item, i) in create_item_model.owners"
            :key="i"
            class="full-width"
          >
            <div class="feild-width">
              ...
              <span class="feild-width__result">{{
                getLabelById(item.regionId, vendors_list)
              }}</span>
            </div>
            <div class="feild-width">
              <span class="feild-width__title">owner name</span> :
              <span class="feild-width__result">{{ item.ownerShipRate }}%</span>
            </div>
          </div>
          <!-- </div> -->
        </div>
