        ...
        <q-form @submit.prevent="addAttachment">
          ...
          >
            ...
            <div class="col-8 row justify-between">
              ...
              <div style="width: 47%">
                <q-input label="Issue Date" v-model="fileDetail.date" />
              </div>
            </div>
...
import { form_data } from "../../composables/reaquist";
...
const addAttachment = () => {
  form_data.value.drawings.push(fileDetail.value);
  reviewAttachments.value.push({
    id: fileDetail.value.id,
    file: filsReview.value,
    docNum: fileDetail.value.docName,
    fileBase64: fileDetail.value.fileBase64,
  });
